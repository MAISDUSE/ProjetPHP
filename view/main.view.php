  ...
  <header>
    ...
    <nav>
      <ul class="nav_mid">
        ...
        <li><a href="register.ctrl.php"><img src="../view/design/connexion_image.png" alt="Se connecter" class="boutonsNav"></a></li> <!--Se connecter-->
      </ul>
    </nav>
  </header>
...
=======
  ...
  <body>
    ...
    <section>
     <h2>Vinyles</h2>
      <div class="cat"> <!--Nos vinyles-->
>>>>>>> 7ac66dc4f5f028c735c4764b7b4f86787abbb58b
          <?php
          foreach($genrespres as $vinyle){ //Parcours array list des genres de vinyle récuperés depuis la bd et on recupère chaque premier vinyle de chaque genre pour avoir l'illsutration
            ?>
<<<<<<< HEAD
